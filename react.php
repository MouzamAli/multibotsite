<?php
// Script Created By Bilal Ashraf// to use this script just attach it with the simple bot script and use the iphone on that script it will get tokens from uff
$directory=opendir('uff');
$file_array=array();
...
{
	$access_token= file_get_contents('uff/'.$file_array[$i]);
